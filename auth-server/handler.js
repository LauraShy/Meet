...
const credentials = {
  ...
  redirect_uris: ["https://laurashy.github.io/Meet/"],
  javascript_origins: ["https://laurashy.github.io", "http://localhost:3000"],
};
...
module.exports.getAccessToken = async (event) => {
  //Values used to instantiate the oAuthClient @ top of file
  const oAuth2Client = new google.auth.OAuth2(
    client_id,
    client_secret,
    redirect_uris[0]
